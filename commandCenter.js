...
chromaHCIapp.CONSTANTS = {
  ...
  'commandList': [
    { 'id': 0, 'command': 'Turn up living room lights',   'key_1': 'ALT', 'key_2': 'O', 'tfreq': 4, 'efreq': 2 },
    { 'id': 1, 'command': 'Turn down living room lights', 'key_1': 'ALT', 'key_2': 'L', 'tfreq': 4, 'efreq': 2 },
    { 'id': 2, 'command': 'Raise the upstairs blinds',    'key_1': 'ALT', 'key_2': 'T', 'tfreq': 6, 'efreq': 3 },
    { 'id': 3, 'command': 'Lower the upstairs blinds',    'key_1': 'ALT', 'key_2': 'R', 'tfreq': 6, 'efreq': 3 },
    { 'id': 4, 'command': 'Turn off all lights',          'key_1': 'ALT', 'key_2': 'Z', 'tfreq': 3, 'efreq': 1 },
    { 'id': 5, 'command': 'Set lights to party mode',     'key_1': 'ALT', 'key_2': 'J', 'tfreq': 2, 'efreq': 1 },
    { 'id': 6, 'command': 'Turn on/off porch lights',     'key_1': 'ALT', 'key_2': 'C', 'tfreq': 4, 'efreq': 2 },
    { 'id': 7, 'command': 'Adjust temperature up 1 deg',  'key_1': 'CTRL', 'key_2': 'S', 'tfreq': 3, 'efreq': 1 },
    { 'id': 8, 'command': 'Adjust temperature down 1 deg','key_1': 'CTRL', 'key_2': 'A', 'tfreq': 3, 'efreq': 1 },
    { 'id': 9, 'command': 'Increase bedroom fan speed',   'key_1': 'CTRL', 'key_2': 'G', 'tfreq': 2, 'efreq': 1 },
    { 'id': 10, 'command': 'Decrease bedroom fan speed',  'key_1': 'CTRL', 'key_2': 'B', 'tfreq': 2, 'efreq': 1 },
    { 'id': 11, 'command': 'Run the dehumidifier',        'key_1': 'CTRL', 'key_2': 'M', 'tfreq': 1, 'efreq': 1 },
    { 'id': 12, 'command': 'Change air conditioner mode', 'key_1': 'CTRL', 'key_2': 'I', 'tfreq': 6, 'efreq': 3 },
    { 'id': 13, 'command': 'Turn on/off dining room fan', 'key_1': 'CTRL', 'key_2': 'P', 'tfreq': 12, 'efreq': 6 },
